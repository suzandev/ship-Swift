...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-white dark:bg-[#1E1E1E] shadow-sm sticky top-0 z-50 transition-colors duration-300">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="px-4 py-2 text-sm border rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300">
                Sign In
              </button>
